...
\underline{Launch-Vehicle and Deployable Space-Structure Optimization:}
\begin{onecolentry}
    \begin{highlights}
        \item Developed gradient-based structural optimization frameworks for conceptual launch-vehicle sizing and a deployable space truss, integrating OpenMDAO, TACS, pyOptSparse, and SNOPT across multiple load cases and configurations.
        \item Formulated stress, buckling, inertial-load, and natural-frequency constraints, including automated classification of axial and bending vibration modes and analytic sizing constraints for multi-component launch vehicles.
        \item Refactored launch-vehicle analysis software into a modular, regression-tested architecture and validated aerodynamic load-distribution and structural sizing methods against publicly available Artemis II vehicle data.
        \item Optimized truss topology, material, and cross-sectional sizing to produce composite designs 32--43\% lighter than comparable aluminum designs, then clustered member properties into manufacturable standardized sizes while quantifying the mass penalty.
    \end{highlights}
\end{onecolentry}
